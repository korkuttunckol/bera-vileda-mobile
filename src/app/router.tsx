...
import { DepotMenuPage } from '@/features/units/components/DepotMenuPage';
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTES.DEPOT, element: <DepotMenuPage /> },
          { path: ROUTES.DEPOT_STOCK, element: <DepotStockPage /> },
